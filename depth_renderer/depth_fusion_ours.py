...
from data_config_ours import ours_rendering_path, watertight_mesh_path, camera_setting_path, total_view_nums, ours_path
from tools.read_and_write_ours import read_exr, read_txt, read_json
import numpy as np
import mcubes
from multiprocessing import Pool
from functools import partial
from tools.utils_ours import dist_to_dep
from settings_ours import cpu_cores
from tools.read_and_write_ours import load_data_path
...
def process_mesh(obj_path, view_ids, cam_Ks, cam_RTs):
    ...
    '''Begin to process'''
    obj_dir = os.path.join(ours_rendering_path, cat, model)
