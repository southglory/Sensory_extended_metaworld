...
from render_helper_ours import *
from settings_ours import *
from data_config_ours import total_view_nums, ours_normalized_path
import multiprocessing
from tools.read_and_write_ours import load_data_path

def render_cmd(result_dict):
    #render rgb
    command = [g_blender_excutable_path, '--background', '--python', 'render_all_ours.py', '--', result_dict]
...
if __name__ == '__main__':
    '''sample viewpoints'''
    all_objects = load_data_path(ours_normalized_path)
