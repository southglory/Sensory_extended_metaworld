...
import sys
sys.path.append('./')
from data_config_ours import our_categories, ours_normalized_path, ours_categlory_pair, model_view_path

g_ours_path = ours_normalized_path
# g_blender_excutable_path = '/home/ynie/Software/blender-2.79b-linux-glibc219-x86_64/blender'
g_blender_excutable_path = '/ssd_2/ssd2048/software_for_papers/blender-2.79b-linux-glibc219-x86_64/blender'
...
g_syn_data_folder = './datasets/OursRenderings'
...
#total 55 categories
g_ours_categlory_pair = ours_categlory_pair
cpu_cores = 4